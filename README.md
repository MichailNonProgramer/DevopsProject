...
```
box (массив из 3 чисел)
Описание: Размеры расчетной области (симуляционного бокса) в трех измерениях

Значение по умолчанию: [10.0, 10.0, 10.0]

Пример: [10.0, 10.0, 10.0] означает кубическую область 10×10×10

time_step (число)
Описание: Временной шаг интегрирования уравнений движения

Значение по умолчанию: 0.01

Единицы измерения: Обычно в безразмерных единицах MD (например, LJ единицы)

Важно: Слишком большой шаг может привести к нестабильности симуляции

positions (массив массивов)
Описание: Начальные позиции частиц в системе

Значение по умолчанию: [[5.0, 5.0, 5.0], [6.0, 5.0, 5.0]]

Пример: Две частицы с координатами (5,5,5) и (6,5,5)

Параметры потенциала Леннарда-Джонса:
lj_epsilon (число)
Описание: Глубина потенциальной ямы (энергетический параметр)

Значение по умолчанию: 1.0

Физический смысл: Определяет силу притяжения между частицами

Пример: epsilon = 1.0 означает базовую единицу энергии

lj_sigma (число)
Описание: Диаметр частиц (расстояние, где потенциал равен нулю)

Значение по умолчанию: 1.0

Физический смысл: Определяет размер частиц

Пример: sigma = 1.0 означает базовую единицу длины

cutoff (число)
Описание: Радиус обрезания потенциала

Значение по умолчанию: 2.5

Физический смысл: Расстояние, после которого взаимодействие не учитывается

Обычное значение: 2.5 * sigma для потенциала Леннарда-Джонса
```
